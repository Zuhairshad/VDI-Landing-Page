...
const metrics = [
  { 
    ...
    suffix: "%", 
    prefix: "",
    label: "Peak model hallucination rate on legal queries",
  },
  { 
    value: 85, 
    suffix: "%", 
    prefix: "",
    label: "Enterprise AI adoption reached in 2026",
  },
  { 
    value: 15, 
    suffix: "M", 
    prefix: "€",
    label: "Maximum EU AI Act penalty for non-compliance",
  },
  { 
    value: 50, 
    suffix: "+", 
    prefix: "",
    label: "Hallucinated citations accepted at NeurIPS 2025",
  },
];
