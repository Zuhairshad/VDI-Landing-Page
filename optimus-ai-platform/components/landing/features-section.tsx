...
const features = [
  {
    ...
    description: "A model produces confident, well-formed prose with no signal indicating which sentences are grounded and which were assembled from statistical likelihood. The errors look exactly like the rest of the document.",
    visual: "ai",
  },
  {
    number: "02",
    title: "A property, not a bug",
    description: "Hallucination is a property of how these systems generate text. Research in 2025 established it cannot be fully eliminated under current architectures, and the residual error concentrates in high-stakes domains.",
    visual: "deploy",
  },
  {
    number: "03",
    title: "The burden was transferred",
    description: "Enterprise AI adoption reached roughly 85% in 2026. Every deployment produces text someone is expected to stand behind. The verification burden did not disappear, it moved to the person whose name goes on the output.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Errors survive review",
    description: "More than fifty papers accepted at NeurIPS 2025, a venue with a 25% acceptance rate, contained AI-hallucinated citations that survived multiple rounds of peer review.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">The two look identical on the page.</span>
          </h2>
        </div>
